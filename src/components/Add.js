...
function Add() {
  ...
  const handleAdd=(e)=>{
    e.preventDefault()                      //to remove refresh
    let ids=uuid()
    console.log(ids);
    let uniqueids=ids.slice(0,8)
  ...
  return (
    <>
      <h1 className='mt-5 text-center text-info'>Add Employee Management</h1>
   ...
   onChange={(e)=>setSalary(e.target.value)} 
      ...
      <Button
       ...
       variant="primary" type="submit" className='border border-5 border-light mb-5 bg-primary text-light'>
        ADD
      </Button>
    </Form>
        </Col>
